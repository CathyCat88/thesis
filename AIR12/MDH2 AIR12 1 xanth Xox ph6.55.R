...
valeurs <- data.frame(read.csv("30 min MDH2 1µl AIR12 1 xanth Xox ph6.55 ttes 10s.csv", sep = ';', dec = ".", header = TRUE))
...
g
save_plot('MDH2 AIR12 1 Xan Xox ph6.55 1min.png', g, base_aspect_ratio = 1.3)
